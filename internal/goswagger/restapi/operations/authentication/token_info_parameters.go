...
// TokenInfoParams contains all the bound params for the token info operation
...
func (o *TokenInfoParams) bindAuthorization(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
