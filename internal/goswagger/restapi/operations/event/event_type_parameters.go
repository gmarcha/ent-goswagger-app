...
func NewEventTypeParams() EventTypeParams {
	...
	return EventTypeParams{}
}

// EventTypeParams contains all the bound params for the event type operation
...
func (o *EventTypeParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
