...
func (fn ListTypeEventsHandlerFunc) Handle(params ListTypeEventsParams, principal *models.Principal) middleware.Responder {
...
func NewListTypeEvents(ctx *middleware.Context, handler ListTypeEventsHandler) *ListTypeEvents {
	return &ListTypeEvents{Context: ctx, Handler: handler}
}
...
func (o *ListTypeEvents) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewListTypeEventsParams()
