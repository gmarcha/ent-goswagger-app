...
func NewListTypeEventsParams() ListTypeEventsParams {
	...
	return ListTypeEventsParams{}
}

// ListTypeEventsParams contains all the bound params for the list type events operation
...
func (o *ListTypeEventsParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
