...
func NewAddTutorParams() AddTutorParams {
	...
	return AddTutorParams{}
}

// AddTutorParams contains all the bound params for the add tutor operation
...
func (o *AddTutorParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
