...
func NewRemoveCalendarParams() RemoveCalendarParams {
	...
	return RemoveCalendarParams{}
}

// RemoveCalendarParams contains all the bound params for the remove calendar operation
...
func (o *RemoveCalendarParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
