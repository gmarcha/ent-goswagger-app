...
// ListUserRolesParams contains all the bound params for the list user roles operation
...
func (o *ListUserRolesParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
