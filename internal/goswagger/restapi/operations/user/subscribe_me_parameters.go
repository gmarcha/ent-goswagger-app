...
func NewSubscribeMeParams() SubscribeMeParams {
	...
	return SubscribeMeParams{}
}

// SubscribeMeParams contains all the bound params for the subscribe me operation
...
func (o *SubscribeMeParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
