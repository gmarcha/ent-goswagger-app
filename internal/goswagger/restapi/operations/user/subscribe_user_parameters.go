...
func NewSubscribeUserParams() SubscribeUserParams {
	...
	return SubscribeUserParams{}
}

// SubscribeUserParams contains all the bound params for the subscribe user operation
...
func (o *SubscribeUserParams) bindEventID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *SubscribeUserParams) bindUserID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
