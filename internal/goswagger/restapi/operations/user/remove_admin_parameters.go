...
func NewRemoveAdminParams() RemoveAdminParams {
	...
	return RemoveAdminParams{}
}

// RemoveAdminParams contains all the bound params for the remove admin operation
...
func (o *RemoveAdminParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
