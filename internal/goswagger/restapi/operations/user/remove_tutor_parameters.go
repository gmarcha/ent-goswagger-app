...
func NewRemoveTutorParams() RemoveTutorParams {
	...
	return RemoveTutorParams{}
}

// RemoveTutorParams contains all the bound params for the remove tutor operation
...
func (o *RemoveTutorParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
