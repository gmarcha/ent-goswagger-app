...
func (o *SubscribeUserURL) Build() (*url.URL, error) {
	...
	if eventID != "" {
		...
		return nil, errors.New("eventId is required on SubscribeUserURL")
	}
	...
	if userID != "" {
		...
		return nil, errors.New("userId is required on SubscribeUserURL")
	}
...
func (o *SubscribeUserURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on SubscribeUserURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on SubscribeUserURL")
	}
