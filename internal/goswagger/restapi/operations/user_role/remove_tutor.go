...
func (fn RemoveTutorHandlerFunc) Handle(params RemoveTutorParams, principal *models.Principal) middleware.Responder {
...
func NewRemoveTutor(ctx *middleware.Context, handler RemoveTutorHandler) *RemoveTutor {
	return &RemoveTutor{Context: ctx, Handler: handler}
}

/* RemoveTutor swagger:route DELETE /users/{id}/role/tutor UserRole removeTutor
...
func (o *RemoveTutor) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewRemoveTutorParams()
