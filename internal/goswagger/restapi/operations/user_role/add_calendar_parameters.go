...
func NewAddCalendarParams() AddCalendarParams {
	...
	return AddCalendarParams{}
}

// AddCalendarParams contains all the bound params for the add calendar operation
...
func (o *AddCalendarParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
