...
func (fn AddAdminHandlerFunc) Handle(params AddAdminParams, principal *models.Principal) middleware.Responder {
...
/* AddAdmin swagger:route POST /users/{id}/role/admin UserRole addAdmin
