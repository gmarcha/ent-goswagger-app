...
func ID(id uuid.UUID) predicate.EventType {
...
func IDEQ(id uuid.UUID) predicate.EventType {
	return predicate.EventType(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id uuid.UUID) predicate.EventType {
	return predicate.EventType(func(s *sql.Selector) {
...
func IDIn(ids ...uuid.UUID) predicate.EventType {
	return predicate.EventType(func(s *sql.Selector) {
...
func IDNotIn(ids ...uuid.UUID) predicate.EventType {
	return predicate.EventType(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func IDGT(id uuid.UUID) predicate.EventType {
	return predicate.EventType(func(s *sql.Selector) {
...
func IDGTE(id uuid.UUID) predicate.EventType {
	return predicate.EventType(func(s *sql.Selector) {
...
func IDLT(id uuid.UUID) predicate.EventType {
	return predicate.EventType(func(s *sql.Selector) {
...
func IDLTE(id uuid.UUID) predicate.EventType {
	return predicate.EventType(func(s *sql.Selector) {
...
func Color(v string) predicate.EventType {
	return predicate.EventType(func(s *sql.Selector) {
...
func ColorEQ(v string) predicate.EventType {
	return predicate.EventType(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldColor), v))
	})
}
...
func ColorNEQ(v string) predicate.EventType {
	return predicate.EventType(func(s *sql.Selector) {
...
func ColorIn(vs ...string) predicate.EventType {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ColorNotIn(vs ...string) predicate.EventType {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ColorGT(v string) predicate.EventType {
	return predicate.EventType(func(s *sql.Selector) {
...
func ColorGTE(v string) predicate.EventType {
	return predicate.EventType(func(s *sql.Selector) {
...
func ColorLT(v string) predicate.EventType {
	return predicate.EventType(func(s *sql.Selector) {
...
func ColorLTE(v string) predicate.EventType {
	return predicate.EventType(func(s *sql.Selector) {
...
func ColorContains(v string) predicate.EventType {
	return predicate.EventType(func(s *sql.Selector) {
...
func ColorHasPrefix(v string) predicate.EventType {
	return predicate.EventType(func(s *sql.Selector) {
...
func ColorHasSuffix(v string) predicate.EventType {
	return predicate.EventType(func(s *sql.Selector) {
...
func ColorEqualFold(v string) predicate.EventType {
	return predicate.EventType(func(s *sql.Selector) {
...
func ColorContainsFold(v string) predicate.EventType {
	return predicate.EventType(func(s *sql.Selector) {
