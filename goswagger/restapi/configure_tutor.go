...
import (
	...
	"github.com/gamarcha/ent-goswagger-app/goswagger/restapi/operations"
	"github.com/gamarcha/ent-goswagger-app/goswagger/restapi/operations/authentication"
	"github.com/gamarcha/ent-goswagger-app/goswagger/restapi/operations/event"
	"github.com/gamarcha/ent-goswagger-app/goswagger/restapi/operations/user"
)

//go:generate swagger generate server --target ../../goswagger --name Tutor --spec ../../api/swagger.yaml --principal models.Principal --exclude-main
...
func configureAPI(api *operations.TutorAPI) http.Handler {
	...
	if api.EventCreateEventHandler == nil {
		api.EventCreateEventHandler = event.CreateEventHandlerFunc(func(params event.CreateEventParams) middleware.Responder {
	...
	if api.EventDeleteEventHandler == nil {
		api.EventDeleteEventHandler = event.DeleteEventHandlerFunc(func(params event.DeleteEventParams) middleware.Responder {
	...
	if api.EventListEventHandler == nil {
		api.EventListEventHandler = event.ListEventHandlerFunc(func(params event.ListEventParams) middleware.Responder {
	...
	if api.EventListEventUsersHandler == nil {
		api.EventListEventUsersHandler = event.ListEventUsersHandlerFunc(func(params event.ListEventUsersParams) middleware.Responder {
	...
	if api.UserListUserHandler == nil {
		api.UserListUserHandler = user.ListUserHandlerFunc(func(params user.ListUserParams) middleware.Responder {
	...
	if api.UserListUserEventsHandler == nil {
		api.UserListUserEventsHandler = user.ListUserEventsHandlerFunc(func(params user.ListUserEventsParams) middleware.Responder {
	...
	if api.EventReadEventHandler == nil {
		api.EventReadEventHandler = event.ReadEventHandlerFunc(func(params event.ReadEventParams) middleware.Responder {
			return middleware.NotImplemented("operation event.ReadEvent has not yet been implemented")
		})
	}
	if api.UserReadUserHandler == nil {
		api.UserReadUserHandler = user.ReadUserHandlerFunc(func(params user.ReadUserParams) middleware.Responder {
			return middleware.NotImplemented("operation user.ReadUser has not yet been implemented")
		})
	}
	if api.UserSubscribeUserHandler == nil {
		api.UserSubscribeUserHandler = user.SubscribeUserHandlerFunc(func(params user.SubscribeUserParams) middleware.Responder {
	...
	if api.UserUnsubscribeUserHandler == nil {
		api.UserUnsubscribeUserHandler = user.UnsubscribeUserHandlerFunc(func(params user.UnsubscribeUserParams) middleware.Responder {
	...
	if api.EventUpdateEventHandler == nil {
		api.EventUpdateEventHandler = event.UpdateEventHandlerFunc(func(params event.UpdateEventParams) middleware.Responder {
