...
func NewReadEventParams() ReadEventParams {
	...
	return ReadEventParams{}
}

// ReadEventParams contains all the bound params for the read event operation
...
func (o *ReadEventParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
