...
type ReadEventHandlerFunc func(ReadEventParams) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadEventHandlerFunc) Handle(params ReadEventParams) middleware.Responder {
	return fn(params)
}

// ReadEventHandler interface for that can handle valid read event params
type ReadEventHandler interface {
	Handle(ReadEventParams) middleware.Responder
}
...
func NewReadEvent(ctx *middleware.Context, handler ReadEventHandler) *ReadEvent {
	return &ReadEvent{Context: ctx, Handler: handler}
}
