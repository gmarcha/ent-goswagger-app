...
func NewListEventUsersParams() ListEventUsersParams {
	...
	return ListEventUsersParams{}
}

// ListEventUsersParams contains all the bound params for the list event users operation
...
func (o *ListEventUsersParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
