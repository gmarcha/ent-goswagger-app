...
func NewTutorAPI(spec *loads.Document) *TutorAPI {
	return &TutorAPI{
		...
		EventCreateEventHandler: event.CreateEventHandlerFunc(func(params event.CreateEventParams) middleware.Responder {
		...
		EventDeleteEventHandler: event.DeleteEventHandlerFunc(func(params event.DeleteEventParams) middleware.Responder {
		...
		EventListEventHandler: event.ListEventHandlerFunc(func(params event.ListEventParams) middleware.Responder {
			return middleware.NotImplemented("operation event.ListEvent has not yet been implemented")
		}),
		EventListEventUsersHandler: event.ListEventUsersHandlerFunc(func(params event.ListEventUsersParams) middleware.Responder {
		...
		UserListUserEventsHandler: user.ListUserEventsHandlerFunc(func(params user.ListUserEventsParams) middleware.Responder {
			return middleware.NotImplemented("operation user.ListUserEvents has not yet been implemented")
		}),
		EventReadEventHandler: event.ReadEventHandlerFunc(func(params event.ReadEventParams) middleware.Responder {
			return middleware.NotImplemented("operation event.ReadEvent has not yet been implemented")
		}),
		UserReadUserHandler: user.ReadUserHandlerFunc(func(params user.ReadUserParams) middleware.Responder {
			return middleware.NotImplemented("operation user.ReadUser has not yet been implemented")
		}),
		UserSubscribeUserHandler: user.SubscribeUserHandlerFunc(func(params user.SubscribeUserParams) middleware.Responder {
			return middleware.NotImplemented("operation user.SubscribeUser has not yet been implemented")
		}),
		UserUnsubscribeUserHandler: user.UnsubscribeUserHandlerFunc(func(params user.UnsubscribeUserParams) middleware.Responder {
			return middleware.NotImplemented("operation user.UnsubscribeUser has not yet been implemented")
		}),
		EventUpdateEventHandler: event.UpdateEventHandlerFunc(func(params event.UpdateEventParams) middleware.Responder {
